...
select top 5 item_purchased, cast((avg(review_rating))as decimal(10,2))
...
cast((100.0 * sum(case when discount_applied = 'Yes' 
		then 1 else 0 end)/count(*)) as decimal(10,2)) as discount_rate
from customer 
group by item_purchased
